    ...
    ui(new Ui::StatisticsPage)
{
    ...
    {
        connect(ui->startButton, SIGNAL(pressed()), this, SLOT(updateStatisticsThin()));
    } else {
...
void StatisticsPage::updateStatisticsThin()
{
    uint64_t nMinWeight = 0, nMaxWeight = 0, nWeight = 0;
    ...
    int nHeight = pwalletMain->nLastFilteredHeight;
    int pPawrate;
    double pPawrate2 = 0.000;
    pPawrate2 = (double)pPawrate;
