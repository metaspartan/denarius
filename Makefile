...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Sep 22 17:06:44 2017
# Project:  denarius-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_LEVELDB=1 USE_QRCODE=1 USE_UPNP=1 -o Makefile denarius-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DUSE_LEVELDB -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/carsen/Desktop/denarius/src/leveldb/libleveldb.a /home/carsen/Desktop/denarius/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: denarius-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_LEVELDB=1 USE_QRCODE=1 USE_UPNP=1 -o Makefile denarius-qt.pro
...
/home/carsen/Desktop/denarius/src/leveldb/libleveldb.a: FORCE
	cd /home/carsen/Desktop/denarius/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/carsen/Desktop/denarius/build/build.h: FORCE
	cd /home/carsen/Desktop/denarius; /bin/sh share/genbuild.sh /home/carsen/Desktop/denarius/build/build.h
