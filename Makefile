...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Oct 7 23:20:50 2017
# Project:  denarius-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_LEVELDB=1 USE_QRCODE=1 USE_UPNP=1 -o Makefile denarius-qt.pro
#############################################################################
