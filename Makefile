...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Oct 5 00:45:47 2017
# Project:  denarius-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_LEVELDB=1 USE_UPNP=1 USE_QRCODE=1 -o Makefile denarius-qt.pro
#############################################################################
...
Makefile: denarius-qt.pro  ../../../../Qt/4.8.6/mkspecs/default/qmake.conf ../../../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_LEVELDB=1 USE_UPNP=1 USE_QRCODE=1 -o Makefile denarius-qt.pro
