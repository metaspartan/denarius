...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Sep 4 14:36:00 2017
# Project:  denarius-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_LEVELDB=1 -o Makefile denarius-qt.pro
#############################################################################
...
Makefile: denarius-qt.pro  ../../../../Qt/4.8.6/mkspecs/default/qmake.conf ../../../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_LEVELDB=1 -o Makefile denarius-qt.pro
